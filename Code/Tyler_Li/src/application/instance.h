...
typedef struct
{
	...
	int rnginitW4Rdelay_sy ;	// receiver turn on delay. this is the delay used after sending a blink and turning on the receiver to receive the ranging init message

	int fwtoTime_sy ;	//this is final message duration (longest out of ranging messages)
	int fwtoTimeB_sy ;	//RX wait time out
